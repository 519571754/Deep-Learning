...
def _get_patches_generic(img, patch_size, is_train, stride):
    ...
    #scaled_temp = resize(img, output_shape=(image_size, image_size)
...
if __name__ == "__main__":
    ...
    ref = np.array(Image.open('00003.png').convert('LA'))[:,:,0] # ref
    dis = np.array(Image.open('00003_out_mix_interpolation.png').convert('LA'))[:,:,0] # dis
    #dis = cv2.resize(dis, (512, 256))
